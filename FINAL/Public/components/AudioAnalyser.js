import BeginPanel from './beginPanel/BeginPanel.js';
import isOnBeat from '../scripts/RealTimeDetect.js';
import initEnvEffect from '../scripts/EnvEffect.js';

//let BeginPanel = window.config;
//let isOnBeat = window.config;
//let initEnvEffect = window.config;
